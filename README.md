...
The attacker attempts to position themselves between the victim and the server.

If the communication is not properly protected, the attacker may be able to observe or manipulate some of the exchanged information.
...
•	🔒 Use encrypted connections such as HTTPS.

•	📶 Avoid unknown or unsecured public Wi-Fi networks.

•	🔐 Use a trusted VPN when appropriate.

•	⚠️ Do not ignore browser security or certificate warnings.
...
Class Activity: Top Hacker Shows Us How It's Done
# #Video: Top Hacker Shows Us How It's Done — Pablos Holman, TEDxMidwests

## MORE ABOUT ME : SANAA EL HABIB KAHLOUL 
## EMAIL : elhabibkahloulsanaa@gmail.com
## LINKEDIN : https://www.linkedin.com/in/sanaa-el-habib-kahloul/
